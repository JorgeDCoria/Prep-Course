...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  let mayores = arreglo.filter(n => n>18);
...
function diaDeLaSemana(numeroDeDia) {
  ...
  switch(numeroDeDia){
    ...
    case 5:
    case 6:
      salida = "Es dia Laboral";
      break;
    default:
      salida = "Numero de dia ingresado no valido";
  }
  return salida;
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  let array = arreglo.filter(e => e===arreglo[0]);
 return array.length === arreglo.length;
